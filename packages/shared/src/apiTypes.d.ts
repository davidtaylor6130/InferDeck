...
export type JobType = "llm_chat" | "llm_generate" | "embedding" | "rag_index" | "image_generate" | "transcription" | "voice_tts";
export type JobStatus = "queued" | "leased" | "running" | "paused" | "succeeded" | "failed" | "cancelled" | "dead_letter";
export type ResourceClass = "gpu_llm" | "gpu_image" | "gpu_audio" | "cpu_index" | "disk_heavy" | "network" | "none";
...
export type SseEventType = "job:created" | "job:updated" | "job:cancelled" | "job:dead_letter" | "queue:changed" | "mode:changed" | "model:loaded" | "model:unloaded" | "service:health" | "service:stated" | "hardware:update" | "system:error";
