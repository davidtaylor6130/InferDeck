...
export const configSchema = z.object({
  ...
  ollama: z.object({
    ...
    baseUrl: z.string().url().default("http://127.0.0.1:11435"),
    manageProcess: z.boolean().default(true),
    executable: z.string().default("ollama"),
  ...
  modes: z.object({
    ...
    gamingMode: z.object({
      ...
      unloadOllamaModels: z.boolean().default(true),
